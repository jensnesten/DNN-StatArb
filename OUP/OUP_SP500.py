...
# Save to CSV
df.to_csv('../Data/sp500_log_returns.csv', index=False)

# Plot the results
plt.figure(figsize=(12, 6))
plt.plot(log_returns.index, log_returns, label='Actual S&P 500 Log Returns')
...
plt.legend()
plt.title('S&P 500 Log Returns vs. Simulated OU Process')
plt.xlabel('Date')
